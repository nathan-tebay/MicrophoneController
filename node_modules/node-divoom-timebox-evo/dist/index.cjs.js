...
var gifWrap = _interopDefault(require('gifwrap'));
...
function color2HexString(color) {
    return new tinycolor.TinyColor(color).toHex();
}
...
var TimeChannel = (function (_super) {
    ...
    function TimeChannel(opts) {
        ...
        _this.color =
            opts && opts.color ? new tinycolor.TinyColor(opts.color) : new tinycolor.TinyColor("FFFFFF");
    ...
    Object.defineProperty(TimeChannel.prototype, "color", {
        ...
        set: function (color) {
            var localcolor = new tinycolor.TinyColor(color);
...
var DisplayText = (function (_super) {
    ...
    DisplayText.prototype.PALETTE_TEXT_ON_BACKGROUND = function (text, background) {
        ...
        var back = (new tinycolor.TinyColor(background)).toHex();
        var front = (new tinycolor.TinyColor(text)).toHex();
    ...
    Object.defineProperty(DisplayText.prototype, "colorPalette", {
        get: function () {
            ...
            palette.forEach(function (color) {
                var lColor = new tinycolor.TinyColor(color);
                if (!lColor.isValid) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        image = _a.sent();
                        resized = new DivoomJimpStatic(image.resize(16, 16, Jimp.RESIZE_NEAREST_NEIGHBOR));
                        ja.push(resized);
                        return [2, ja];
                }
            });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        inputGif.frames.forEach(function (frame, index) {
                            var image = gifWrap.GifUtil.copyAsJimp(DivoomJimpAnim, frame).resize(16, 16);
...
exports.TIMEBOX_CONST = TIMEBOX_CONST;
